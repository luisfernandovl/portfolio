  ...
  return (
    <section id={'projetos'} className={Style.container}>
      ...
      <ul id='project_list' className={Style.list_view}>
        ...
        <Card gif={PortfolioGIF} image={PortfolioJPG} title='Portfólio [Legado]' description='Site anterior a este.' tags='#HTML #CSS #JavaScript' link='https://luisfernandovl.vercel.app' />        
      </ul>
    </section>
  );
}